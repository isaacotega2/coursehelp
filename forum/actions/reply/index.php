<?php
	...
	$topicId = commentDetails($commentId)["topicId"];
	...
	if(isset($_POST["reply"])) {
		...
		$sql = "INSERT INTO replies (reply_id, replier_usercode, comment_id, reply, date_posted, time_posted) VALUES ('$replyId', '" . $user["account"]["usercode"] . "', '$commentId', '$reply', '$date', '$time') ";
		
		if(mysqli_query($conn, $sql)) {
		
			echo '<script> window.location.href = "' . $page["rootPath"] . "topic?id=" . $topicId . "#" . $replyId . '"; </script>';
