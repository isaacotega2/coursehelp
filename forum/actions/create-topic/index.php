	...
	if(isset($_POST["title"])) {
		...
		if(mysqli_query($conn, $sql)) {
			...
			if(isset($_FILES["image1"])) {
				...
				$filePath = ($page["rootPath"] . "images/posts/" . $topicId . "_1.jpg");
			...
			if(isset($_FILES["image2"])) {
				...
				$filePath = ($page["rootPath"] . "images/posts/" . $topicId . "_2.jpg");
			...
			if(isset($_FILES["image1"])) {
				...
				$filePath = ($page["rootPath"] . "images/posts/" . $topicId . "_3.jpg");
