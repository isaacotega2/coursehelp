  ...
  <div class="head-div"> <span style="display: flex; justify-content: center;
    ...
    <?php
    		...
    		foreach($website["content"]["mainCourses"]["ids"] as $eachId) {
 			...
 			echo '<div class="forum-container"><img style=" width: 50px; margin-top: 5px; float: left;" src="forumIMG/feedback-smallcanvas-1080x675.png"><p ><a href="?id=' . $eachId . '">' . mainCourseDetails($eachId)["name"] . '</a></p></div>';
