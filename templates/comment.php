...
<div class="comment" id="<?php echo $commentDetails["commentId"]; ?>"><p style="color: grey;"><a href="<?php echo $page["rootPath"]; ?>profile?id=<?php echo $commentDetails["commenterUsercode"]; ?>"><?php echo accountDetails($commentDetails["commenterUsercode"])["nickname"]; ?></a> commented: <?php echo $commentDetails["timePosted"]; ?> on <?php echo $commentDetails["datePosted"]; ?></p>
