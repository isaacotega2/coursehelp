<?php
	...
	if(isset($_POST["reply"])) {
		...
		if(isset($_GET["unbased"])) {
			...
			notify($topicDetails["posterUsercode"], accountDetails($user["account"]["usercode"])["profilePicture"], ("funny-wierd-questions#" . $replyId), (accountDetails($user["account"]["usercode"])["nickname"] . " replied to your post, click to view."));
			...
			notify(replyDetails($baseId)["replierUsercode"], accountDetails($user["account"]["usercode"])["profilePicture"], ("funny-wierd-questions#" . $replyId), (accountDetails($user["account"]["usercode"])["nickname"] . " replied to your comment, click to view."));
		...
		if(mysqli_query($conn, $sql)) {
			...
			echo '<script> window.location.href = "' . $page["rootPath"] . 'funny-wierd-questions#' . $replyId . '"; </script>';
