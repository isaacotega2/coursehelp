<?php
	...
	if($result = mysqli_query($conn, $sql)) {
		...
		if(mysqli_query($conn, $sql)) {
			...
			notify(replyDetails($replyId)["replierUsercode"], accountDetails($user["account"]["usercode"])["profilePicture"], ("funny-wierd-questions#" . $replyId), (accountDetails($user["account"]["usercode"])["nickname"] . " liked your comment, click to view."));
