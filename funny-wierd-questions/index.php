...
<span style="display: flex; justify-content: center;
  ...
  font-weight: 500;" id="topicBody"><pre><?php echo $questionDetails["question"]; ?></pre></span>
  
<button class="comment-button"><a href="actions/reply?topic-id=<?php echo $questionId; ?>&unbased"> Post Reply </a></button>
</div> 
  <div class="FW" style="margin-top: 48px; height: 60%; background-color: rgb(238, 216, 216);">
  
    <?php
    	
    		$baseFolder = "funny-wierd-questions";
    	
    		$commentArray = array();
    
      	foreach($questionDetails["list"]["replies"]["ids"] as $eachId) {
